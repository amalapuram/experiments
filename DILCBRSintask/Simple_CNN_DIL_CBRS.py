...
for name in names:
  ...
  data = np.load("../data/"+name1,allow_pickle=True) # loads the individual data for each class
  arrs[name] = data
...
optimizer = tf.keras.optimizers.Adamax(lr=0.000001)      #Optimizer to use while training
